      ...
      <table class="table table-striped b-t b-light " id="myTable">
        ...
        <tbody>
          ...
          <tr>
            ...
            ?><a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"><span style="color: green" class="fa fa-thumbs-up"></span></a>
            <?php
              }else{
            ?>
              <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"><span style="color: red" class="fa fa-thumbs-down"></span></a>
            <?php
             } 
            ?>
            </span></td>
